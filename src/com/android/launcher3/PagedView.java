...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public static final String TT = "xubin-debug";
    ...
    // The viewport whether the pages are to be contained (the actual view may be larger than
    // the viewport) workspace大小
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.d(TT, "verticalPadding=" + verticalPadding);
            ...
            case MotionEvent.ACTION_MOVE:
                if (mTouchState == TOUCH_STATE_SCROLLING) {
                    ...
                    if (pageUnderPointIndex > -1 && pageUnderPointIndex != indexOfChild(mDragView) && !isHoveringOverDelete) {
                        ...
                        getFreeScrollPageRange(mTempVisiblePagesRange);
                        if (mTempVisiblePagesRange[0] <= pageUnderPointIndex && pageUnderPointIndex <= mTempVisiblePagesRange[1]
    ...
    void animateDragViewToOriginalPosition() {
        if (mDragView != null) {
            ...
            anim.playTogether(ObjectAnimator.ofFloat(mDragView, "translationX", 0f), ObjectAnimator.ofFloat(mDragView, "translationY", 0f),
    ...
    private void onDropToDelete() {
        ...
        motionAnim.playTogether(ObjectAnimator.ofFloat(dragView, "scaleX", toScale), ObjectAnimator.ofFloat(dragView, "scaleY", toScale));
