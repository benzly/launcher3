...
public class FocusIndicatorView extends View implements View.OnFocusChangeListener {
    ...
    static final int DEFAULT_LAYOUT_SIZE = 100 + 150;
    ...
    public FocusIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAlpha(0);
        // setBackgroundResource(R.drawable.highlight_angle_06);
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (hasFocus) {
            ...
            if (getAlpha() > MIN_VISIBLE_ALPHA) {
                ...
                mCurrentAnimation =
                        LauncherAnimUtils.ofPropertyValuesHolder(this, PropertyValuesHolder.ofFloat(View.ALPHA, 1),
